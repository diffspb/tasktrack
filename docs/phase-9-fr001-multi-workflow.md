...
- [ ] `stories/core.md` G — обновить AC, добавить истории
- [ ] `stories/planning.md` K — обновить BoardColumn AC, добавить историю маппинга
- [ ] `09-mvp.md` — приоритизация новых историй
- [ ] `12-data-model.md` — новые таблицы, Workflow nullable, TaskType.default_workflow_id, ERD
- [ ] `15-api.md` — задокументировать новые эндпоинты

### Стадия 2 — Архитектурное ревью

- [ ] Создать `docs/17-arch-review-2.md` (дата, объём, найденные delta)
- [ ] Устранить критические расхождения docs/код
- [ ] Закрыть открытые вопросы дизайна FR-001
